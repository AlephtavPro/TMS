...
<div class="modal fade" id="modal_profile" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered  " role="document">
    ...
    <div  style="padding: 0px" class="col-sm-8"> <input  id="" class="form-control  "  placeholder="" value=" {{ Auth::user()->name }}  ">
      
   </div>
  </div>
<div class="form-group row">
    <label style="text-align: right" class=" col-sm-3 "for="">Email</label>
    <div  style="padding: 0px" class="col-sm-8"> <input  id="" class="form-control" placeholder="" value= {{ Auth::user()->email }}  >
